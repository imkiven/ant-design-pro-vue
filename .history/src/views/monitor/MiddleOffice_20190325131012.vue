          ...
          <a-card title="网上开户">
            <a-row>
              ...
              <a-col :sm="{ span: 4}" :md="{ span: 4}" :lg="{ span: 3}">
                <div class="ht-content" style="margin-top:1rem;text-align:right">成功率</div>
              </a-col>
              <a-col :sm="{ span: 10}" :md="{ span: 10}" :lg="{ span: 4}">
                <div id="wskhSuccessRateCharts" style="height: 6rem;"></div>
              </a-col>
            </a-row>
            <a-row>
              <a-col>
                <div id="wskhEcharts" style="height: 24rem;"></div>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="融资融券">
            <a-row>
              ...
              <a-col :xs="24" :sm="24" :md="{ span: 6}" :lg="{ span: 4}">
                <a-row>
                  <a-col :xs="24" :sm="24" :md="{ span: 6}" :lg="{ span: 6}">
                    <div class="ht-content" style="margin-top:1rem">
                      时延
                      <strong class="ht-number">4ms</strong>
                      <a-progress
                        type="line"
                  ...
                  <a-col :xs="24" :sm="24" :md="{ span: 6}" :lg="{ span: 18}">
                    <div class="ht-content" style="margin-top:1rem">
                      成功率
