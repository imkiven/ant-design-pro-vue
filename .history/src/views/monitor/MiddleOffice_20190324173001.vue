          ...
          <a-row>
            <a-col :span="12">
              <div class="ht-section">
                <p class="ht-content">
                  当日开户数
                  <strong class="ht-number"> 564,900</strong> <small class="ht-percent">11.38%</small>  <small class="ht-percent-tips">同比昨日</small>
                </p>
                <p class="ht-content">
                  开户失败数
                 <strong class="ht-number"> 564,900</strong> <small  class="ht-percent">11.38%</small> <small class="ht-percent-tips"> 同比昨日</small>
            ...
            <a-col :span="3" :offset="1">
              <div class="ht-content">
                时延 <strong class="ht-number"> 4ms</strong>
                <a-progress
                  type="line"
                  :percent="75"
                  :showInfo="false"
        ...
        series: [
          {
            ...
            data: [{ value: 98, name: '成功率' , itemStyle: {
                    normal: {//颜色渐变
