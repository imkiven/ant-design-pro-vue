...
export default {
  ...
  computed: {
    ...mapState({
      ehtsecLine: 'ehtsecLine',
      ehtsecState: 'ehtsecState',
      ehtsecBase: 'ehtsecBase',
      ehtsecWaitline: 'ehtsecWaitline'
    })
  },
  mounted() {
    this.drawLine()
