          ...
          <a-card title="e海通财手机端">
            <a-row>
              ...
              <a-col :sm="{ span: 12}" :md="{ span: 12}" :lg="{ span:8}">
                <p class="ht-content" style="margin-top:1rem">
                  交易量
                  <strong class="ht-number">564,900</strong>
                  <br>
              ...
              <a-col :sm="{ span: 12}" :md="{ span: 12}" :lg="{ span: 8}">
                <div class="ht-content">
                  <a-row>
                    <a-col :sm="{ span: 12}" :md="{ span: 14}" :lg="{ span: 14}">
                      时延
                      <strong class="ht-number">4ms</strong>
                    </a-col>
                    <a-col :sm="{ span: 12}" :md="{ span: 10}" :lg="{ span: 10}">
                      <a-progress
                        type="line"
                        :percent="75"
                        :showInfo="false"
            ...
            <a-row>
              <a-col>
                <div id="ehtcappCharts" style="height: 24rem;"></div>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="融资融券">
...
export default {
  ...
  methods: {
    ...mapActions(['ehtsecState', 'ehtsecLine', 'succState', 'succLine']),
    drawLine() {
      let ehtcappCharts = echarts.init(document.getElementById('ehtcappCharts'))
