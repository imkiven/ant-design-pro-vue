      ...
      <a-col :sm="24" :md="24" :lg="11">
        <section class="ht-left-section">
          ...
          <a-card title="e海通财手机端">
            ...
            >
              <a-row>
                ...
                <a-col :sm="24" :md="16" :lg="{ span: 16}">
                  <v-chart id="ehtsecAppCPUCharts" :options="ehtsecAppCPUOptions" style="height: 266px;width:100%"></v-chart>
                  <v-chart id="ehtsecAppMenCharts" :options="ehtsecAppMenOptions" style="height: 266px;width:100%"></v-chart>
                  <v-chart id="ehtsecAppDiskCharts" :options="ehtsecAppDiskOptions" style="height: 266px;width:100%"></v-chart>
                </a-col>
              </a-row>
            </a-modal>
            <a-row>
            ...
            <a-row>
              <a-col>
                <v-chart id="ehtsecAppCharts" :options="ehtsecAppOptions" style="height: 266px;width:100%"></v-chart>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="e海通财PC端">
            ...
            <a-row>
              <a-col>
                <v-chart id="ehtsecPcCharts" :options="ehtsecPcOptions" style="height: 266px;width:100%"></v-chart>
              </a-col>
            </a-row>
          </a-card>
        </section>
