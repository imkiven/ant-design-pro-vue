<template>
  <div>
    <a-divider style="font-weight:600;font-size: 20px;">站点防火墙及AD设备性能展示</a-divider>
    <a-row :gutter="50">
      <a-col :span="12">
        <a-table
    ...
    <a-divider style="font-weight:600;font-size: 20px;">e海通财交易监控</a-divider>
    <a-row :gutter="50">
      <a-col :span="12">
        <a-table
          :rowKey="(record)=>record.ip"
    ...
    <a-divider style="font-weight:600;font-size: 20px;">交易站点--广域网专线</a-divider>
    <a-row>
      <a-table
    ...
    <a-divider style="font-weight:600;font-size: 20px;">交易站点--互联网线路</a-divider>
    <a-row>
      <a-table
        :rowKey="(record)=>record.ipaddr+record.indexname"
        :columns="llAnalysisColumns"
...
export default {
  ...
  methods: {
    ...mapActions([
      'doAdAndFireWall',
      'doEhtsecServerAnalysis',
      'doLlServerAnalysis',
      'doLlzxServerAnalysis',
      'doLlhlwxServerAnalysis'
    ])
  },
  beforeDestroy() {
