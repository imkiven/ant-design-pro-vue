            ...
            >
              <a-row>
                ...
                <a-col :sm="24" :md="16" :lg="{ span: 16}">
                  <div id="ehtsecAppCPUCharts" style="height: 266px;width:100%"></div>
                  <div id="ehtsecAppMenCharts" style="height: 266px;width:100%"></div>
                  <div id="ehtsecAppDiskCharts" style="height: 266px;width:100%"></div>
                </a-col>
              </a-row>
            </a-modal>
            <a-row>
