          ...
          <a-card title="e海通财手机端">
            <!-- <a-row>
              <a-col :sm="24" :md="24" :lg="{ span: 8}">
                <p class="ht-content">
                  用户数
                  <strong class="ht-number">{{ehtsecState.user}}</strong>
                </p>
                <p class="ht-content">
                  等待数
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['doEhtsecLine','doEhtsecBase']),
    drawLine() {
      ...
      ehtsecPcCharts.setOption({
        ...
        dataset: {
          ...
          dimensions: ['product', 2015, 2016, '2047'],
          source: [
              {product: '今日', '2015': 43.3, '2017': 93.7},
              {product: '昨日', '2015': 83.1, '2016': 73.4, '2017': 55.1},
              {product: '延迟', '2015': 6.4, '2016': 5.2, '2017': 2.5},
          ]
        },
        graphic: [
          {
