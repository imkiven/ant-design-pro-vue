  ...
  data() {
    let ehtsecAppOptions = {
      ...
      xAxis: {
        type: 'category',
        boundaryGap: false,
        data: this.$store.state.single.ehtsecLine.x,
        axisLine: {
          lineStyle: {
            color: '#1C5F88',
            width: 0
      ...
      series: [
        {
          name: '今日',
          data: this.$store.state.single.ehtsecLine.y,
          type: 'line',
          symbol: 'none',
          smooth: true,
          yAxisIndex: 0,
        ...
        {
          name: '基线',
          data: this.$store.state.single.ehtsecBase.y,
          type: 'line',
          symbol: 'none',
          yAxisIndex: 0,
          itemStyle: {
        ...
        {
          name: '等待数',
          data: this.$store.state.single.ehtsecWaitline.y,
          type: 'line',
          symbol: 'none',
          yAxisIndex: 1,
          smooth: true,
