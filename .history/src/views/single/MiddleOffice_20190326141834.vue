          ...
          <a-card title="融资融券">
            <a-row>
              <a-col :xs="24" :sm="24" :md="{ span: 18}" :lg="{ span:18}">
                <div id="rzrqCharts" style="height: 400px;"></div>
              </a-col>
          ...
          <a-row>
            <a-col :sm="24" :md="24" :lg="13">
              <a-card title="账户中心">
                ...
                <a-row>
                  <a-col :span="24">
                    <div id="zhzxCharts" style="height: 180px;"></div>
                  </a-col>
                </a-row>
              </a-card>
            </a-col>
            <a-col :sm="24" :md="24" :lg="11">
              <a-card title="银证转账">
                ...
                <a-row>
                  <a-col :span="24">
                    <div id="yzzzCharts" style="height: 180px;"></div>
                  </a-col>
                </a-row>
              </a-card>
            </a-col>
          ...
          <a-row>
            <a-col :span="24">
              <a-card title="员工平台" class="ht-section">
                ...
                <a-row>
                  <div id="ygptEcharts" style="height: 180px;"></div>
                </a-row>
              </a-card>
            </a-col>
          </a-row>
