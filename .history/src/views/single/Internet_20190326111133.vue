      ...
      <a-col :sm="24" :md="24" :lg="11">
        <section class="ht-left-section">
          ...
          <a-card title="e海通财PC端">
            ...
            <a-row>
              <a-col>
                <div id="ehtsecPcCharts" style="height: 20rem;"></div>
              </a-col>
            </a-row>
          </a-card>
        </section>
          ...
          <a-card title="e海方舟">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                <div id="ehfzCharts" style="height: 15rem;"></div>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="通达信">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                <div id="tdxCharts" style="height: 15rem;"></div>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="同花顺">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                <div id="thsCharts" style="height: 15rem;"></div>
              </a-col>
            </a-row>
          </a-card>
        </section>
...
export default {
  ...
  methods: {
    ...
    drawLine() {
      ...
      let ehfzCharts = echarts.init(document.getElementById('tdxCharts'))
      let ehfzCharts = echarts.init(document.getElementById('thsCharts'))
