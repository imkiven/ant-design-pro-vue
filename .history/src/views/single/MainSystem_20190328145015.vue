        ...
        <section class="ht-left-section">
          ...
          <a-card title="融资融券">
            <a-row>
              ...
              <a-col :sm="{ span: 12}" :md="{ span: 12}" :lg="{ span: 6;off}">
                <div class="ht-content">
                  时 延
                  <strong class="ht-number">4ms</strong>
                  <a-progress
            ...
            <a-row>
              ...
              <a-col :sm="{ span: 24}" :md="{ span: 24}" :lg="{ span: 6}">
                <div class="ht-content" style="text-align:center;margin:30px 0 10px;">
                  成功率
                  <div id="rzrqSuccessRateCharts" style="height: 100px;"></div>
                </div>
              </a-col>
            </a-row>
          </a-card>
