      ...
      <a-col :sm="24" :md="24" :lg="11">
        <section class="ht-left-section">
          ...
          <a-card title="e海通财手机端">
            ...
            >
              <a-row>
                <a-col :sm="24" :md="8" :lg="{ span: 8}">
                  ...
                  <div class="demo-infinite-container">
                    <a-list size="large" bordered :dataSource="data">
                      <div slot="header">
                        <a-row>
                          <a-col :sm="12" :md="12" :lg="{ span:12}">IP</a-col>
                          <a-col :sm="12" :md="12" :lg="{ span:12}">机房位置</a-col>
                        </a-row>
                      </div>
                ...
                <a-col :sm="24" :md="16" :lg="{ span: 16}">
                  <div id="ehtsecAppCPUCharts" style="height: 266px;"></div>
                  <div id="ehtsecAppMenCharts" style="height: 266px;"></div>
                  <div id="ehtsecAppDiskCharts" style="height: 266px;"></div>
                </a-col>
              </a-row>
            </a-modal>
            <a-row>
            ...
            <a-row>
              <a-col>
                <v-chart id="ehtsecAppCharts" :options="ehtsecAppOptions" style="height: 266px;"></v-chart>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="e海通财PC端">
            ...
            <a-row>
              <a-col>
                <v-chart id="ehtsecPcCharts" :options="ehtsecPcOptions" style="height: 266px;"></v-chart>
              </a-col>
            </a-row>
          </a-card>
        </section>
          ...
          <a-card title="e海方舟">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                <v-chart id="ehfzCharts" :options="ehfzOptions" style="height: 266px;"></v-chart>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="通达信">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                 <v-chart id="tdxCharts" :options="tdxOptions" style="height: 245px;"></v-chart>
              </a-col>
            </a-row>
          </a-card>
          <a-card title="同花顺">
            <a-row>
              ...
              <a-col :sm="24" :md="24" :lg="18">
                <v-chart id="thsCharts" :options="thsOptions" style="height: 245px;"></v-chart>
              </a-col>
            </a-row>
          </a-card>
        </section>
...
export default {
  ...
  methods: {
    ...
    setEhtsecModal(modalVisible) {
      ;(this.modalVisible = modalVisible), this.drawDeatilLine()
    },
    onChange(e) {
    ...
    drawDeatilLine() {
      // let ehtsecAppCPUCharts = echarts.init(document.getElementById('ehtsecAppCPUCharts'))
      // let ehtsecAppMenCharts = echarts.init(document.getElementById('ehtsecAppMenCharts'))
      let ehtsecAppDiskCharts = echarts.init(document.getElementById('ehtsecAppDiskCharts'))
      ehtsecAppDiskCharts.setOption({
        title: {
          left: 'left',
          text: '在线用户基数',
          textStyle: {
