...
export const constantRouterMap = [
  ...
  // 单页面路由
  {
    ...
    redirect: '/single/Monitor01',
    hidden: true,
    children: [
      {
        path: 'middleOffice',
        name: 'middleOffice',
        component: () => import(/* webpackChunkName: "single" */ '@/views/single/MiddleOffice')
      },
      {
        path: 'internet',
        name: 'internet',
        component: () => import(/* webpackChunkName: "single" */ '@/views/single/Internet')
      },
      {
        path: 'mainSystem',
        name: 'mainSystem',
        component: () => import(/* webpackChunkName: "single" */ '@/views/single/MainSystem')
      },
      {
        path: 'monitor01',
        name: 'monitor01',
        component: () => import(/* webpackChunkName: "monitor01" */ '@/views/single/Monitor01')
      },
      {
        path: 'monitor02',
        name: 'monitor02',
        component: () => import(/* webpackChunkName: "single" */ '@/views/single/Monitor02')
      }
    ]
  },
  {
